...
zero_p_one_matrix = np.zeros((480, 3)) + 0.1
...
for i in range(n):
    ...
    random_vector = np.random.rand(480, 3)
...
alpha_list = [(np.linspace(0, 20, 101),         # Exponential + Manhatten
               np.linspace(0, 250, 101),        # Exponential + Euclidean
               np.linspace(0, 250, 101)),       # Exponential + Cosine
